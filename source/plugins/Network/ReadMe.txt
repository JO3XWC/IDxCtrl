========================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : Network プロジェクトの概要
========================================================================


この Network DLL は、AppWizard により作成されました。この DLL は MFC の基本的な使い方を示すだけでなく、DLL を作成するための開始点でもあります。

このファイルには、Network DLL を構成する各ファイルの内容の概略が記述されています。
...
Network.h
    これは DLL のメインのヘッダー ファイルです。CNetworkApp クラスを宣言します。

Network.cpp
    これは、メインの DLL ソース ファイルです。CNetworkApp クラスが含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、Network.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
